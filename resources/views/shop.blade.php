                                        ...
                                        <li>
                                            <div class="form-check ps-0 custome-form-check">
                                                ...
                                                @if (in_array($brand->id, explode(',', $q_brands)))
                                                    checked="checked"
                                                @endif
                                                onchange="filterProductByBrands(this)"
                                                />
        ...
        <div class="row">
            <div class="col-lg-8 col-md-6">
                <div class="subscribe-details">
                    ...
                    <h6 class="font-light">Subscribe and receive our newsletters to follow the news about our fresh and fantastic Products.</h6>
                </div>
            </div>
...
@push('scripts')
    <script>
        ...
        function filterProductByBrands(brand){
            var brands = "";
