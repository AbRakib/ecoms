                ...
                <table class="table cart-table wishlist-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('shop.product.details', $item->model->slug) }}" class="font-light">{{$item->model->name}}</a>
                            ...
                            <td>
                                ...
                                class="icon" 
                                onclick="moveWishlistToCart('{{$item->rowId}}')">
                                    <i class="fas fa-shopping-cart"></i>
                                </a>
                                @else
...
@push('scripts')
    <script>
        ...
        function moveWishlistToCart(rowId){
            $("#id").val(rowId);
            $("#moveToCart").submit();
        }
    </script>
