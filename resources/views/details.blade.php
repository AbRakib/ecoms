                                ...
                                <div class="col-lg-10">
                                    <div class="details-image-1 ratio_asos">
                                        ...
                                        @if ($product->images)
                                            ...
                                            @foreach ($images as $image)
                                                <div>
                                                    <img src="{{asset('/assets/images/fashion/product/front')}}/{{$image}}" class="img-fluid w-100 image_zoom_cls-0 blur-up lazyload" alt="{{$product->name}}">
                                                </div>
                                            @endforeach
                                        @endif
                        ...
                        <div class="col-md-6">
                            <div class="cloth-details-size">
                                ...
                                <div class="product-buttons">
                                    ...
                                    document.getElementById('addtocart').submit();" id="cartEffect" class="btn btn-solid hover-solid btn-animation">
                    ...
                    <div>
                        <div class="product-box">
                            <div class="img-wrapper">
                                ...
                                <div class="back">
                                    <a href="{{ route('shop.product.details', $product->slug) }}">
                                        <img src="{{asset('/assets/images/fashion/product/back')}}/{{$product->image}}" class="bg-img blur-up lazyload" alt="{{$product->name}}">
                                    </a>
                                </div>
                                <div class="cart-wrap">
                                    <ul>
                            ...
                            <div class="product-details">
                                ...
                                <div class="main-price">
                                    ...
                                    <div class="listing-content">
                                        ...
                                        <p class="font-light">{{ $product->short_descripton }}</p>
                                    </div>
